<template>
  <el-form :model="ruleForm2" :rules="rules2" ref="ruleForm2" label-position="left" label-width="0px" class="demo-ruleForm login-container">
    ...
    <div class="form-options">
      <el-link href="" @click="$router.push('/user/register')" class="link">没注册？先注册一下吧！</el-link>
      <el-link href="" @click="$router.push('/admin/login')" class="link">跳转到管理员界面</el-link href="#">
    </div>
